...
const ButtonGroup = ({ next, previous, goToSlide, ...rest }) => {
    ...
    return (
        <div className="carousel-button-group">
            <button className={currentSlide === 0 ? 'disable prevBtn' : 'prevBtn'} onClick={() => previous()} >
                <FontAwesomeIcon icon={faLessThan} /></button>
            <button className=' nextBtn' onClick={() => next()} > <FontAwesomeIcon icon={faGreaterThan} /> </button>
        </div>
    );
};
...
function CourseCarousel() {
    ...
    return (
        <Container fluid className="bg-light padding_b_15px section" id='joinbesst_media'>
            <div class="reg_layout_2">
                    <div class="reg_head">
                        Join BESST today
                    </div>
                    <div class="reg_para text_align">
                        Register for a BESST account to get personalised course recommendations and offers
                        <br />straight to your inbox, Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    </div>
                    <button className="reg_btn" type="button">Register Now</button>
                </div>
            <Col md={11} sm={11} xs={11} className="align_center">
                ...
                <Carousel responsive={responsive} className='row' arrows={false} renderButtonGroupOutside={true} customButtonGroup={<ButtonGroup />} swipeable={true} draggable={true} scrollable={true} ssr={true} infinite={false} keyBoardControl={true} itemClass="carousel-item-padding-40-px" containerClass="carousel-container">
                            ...
                            <Card className='reg_img_card'>
                                <div>
                                    <img src="./assets/logo 2/048b0a350d211144e407a76d2219d86b.png" alt="image1"
                                        width="150.207px" height="160.111px" />
                                </div>
                            </Card>
                            <Card className='reg_img_card'>
                                <div>
                                    <img src="./assets/logo 2/86e4b3abbdf5cf899952c5d39ab4e42e.png" alt="image2"
                                        width="150.207px" height="160.111px" />
                                </div>
                            </Card>
                            <Card className='reg_img_card'>
                                <div>
                                    <img src="./assets/logo 2/310f946ad5cf558b778f3ddd73a0722b.png" alt="image3"
                                    width="150.207px" height="160.111px" />
                                </div>
                            </Card>
                            <Card className='reg_img_card'>
                                <div>
                                    <img src="./assets/logo 2/97414ed0a242f09762fbfca9f4dc0e4e.png" alt="image4" 
                                    width="150.207px" height="160.111px" />
                                </div>
                            </Card>
                            <Card className='reg_img_card'>
                                <div>
                                    <img src="./assets/logo 2/310f946ad5cf558b778f3ddd73a0722b.png" alt="image4" 
                                    width="150.207px" height="160.111px" />
                                </div>
                            </Card>
                            <Card className='reg_img_card'>
                                <div>
                                    <img src="./assets/logo 2/86e4b3abbdf5cf899952c5d39ab4e42e.png" alt="image4" 
                                    width="150.207px" height="160.111px" />
                                </div>
                            </Card>
                </Carousel>
